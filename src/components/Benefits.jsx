function Benefits () {
    return(
        <div className="w-full p-5 border-b-4 border-[#3c3934] h-auto grid grid-cols-1 md:grid-cols-2 gap-4 col-span-12 bg-blue-300 mt-5">
            <h1 className="text-2xl text-center col-span-2 mb-4">Ventajas y Beneficios de FunghySoft (TRTS)</h1>

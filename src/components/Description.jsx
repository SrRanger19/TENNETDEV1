function Description () {
    return(
        <div className="w-full h-auto grid grid-cols-1 col-span-12 mt-24 p-5 border-b-4 border-[#3c3934]">
            <h1 className="text-2xl text-center col-span-2 mb-4 font-semibold">Descripcion</h1>
            <div className="w-full h-auto grid grid-cols-2 grid-rows-2 gap-4">
                <div className="col-start-1 row-start-1 col-span-1 bg-white p-5 rounded-lg shadow-lg">
                    <h1>
                ...
                <div className="col-start-2 row-start-1 col-span-1 flex justify-center items-center">
                    <img src="./1.jpeg" className="w-80 h-32 object-contain"/>
                </div>
                <div className="col-start-1 row-start-2 col-span-1">
                    <img src="./2.jpeg" className="w-80 h-30 object-contain"/>
                </div>
                <div className="col-start-2 row-start-2 col-span-1 bg-white p-5 rounded-lg shadow-lg">
                    <h1>
